...
const NewTaskForm = () => {
  ...
  const SubmitButton = () => {
    ...
    return (
      <button type='submit' className='mt-8 py-2 w-full rounded-md text-white bg-gray-800 hover:bg-gray-700 text-sm font-semibold shadow-sm hover:shadow-md disabled:bg-gray-400' disabled={pending}>作成</button>
    )
  }
